 ...
 * абсолютной мощностью. Из значений ГИС вычитается определенное значение
 ...
 * @author NovopashinAV
 */
public class WidthAndMeanGISForGeophysLayerMinusValue extends Task implements MeanGIS, Micromine {
    ...
    public WidthAndMeanGISForGeophysLayerMinusValue(String[] inputParameters)
