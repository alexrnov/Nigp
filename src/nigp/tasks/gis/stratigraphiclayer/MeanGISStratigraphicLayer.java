...
public class MeanGISStratigraphicLayer extends Task implements nigp.tasks.MeanGIS, Stratigraphy, Micromine {
    ...
    public MeanGISStratigraphicLayer(String[] inputParameters) throws TaskException {
