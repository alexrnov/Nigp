 ...
 * @author NovopashinAV
 */
public class AbsoluteGeophysicalLayers extends Task implements MeanGIS, Micromine, TablesAction {
     ...
     */
    private String geophysIntervals;
     ...
     * (абсолютная мощность геофизического пласта, статистические параметры)
     * для Micromine
     */
    ...
    /*
     * количесвто полей вместе с абсолютной мощностью и статистическими
     * параметрами геофизических пластов
     */
    private final int fieldsWithAbsoluteDepthAndStatistic = 17;

    /* количесвто полей вместе с абсолютной мощностью */
    private final int fieldsWithAbsoluteDepth = 10;


    public AbsoluteGeophysicalLayers(String[] inputParameters)
    ...
    */
    private boolean wellWithData(Map<String, String> point) {
        if (point.size() == fieldsWithAbsoluteDepthAndStatistic || //есть данные по ТН, абсолютной мощности, статистическим параметрам
                point.size() == fieldsWithAbsoluteDepth) { //есть данные по ТН и абсолютной мощности
            return true;
        } else {
            return false;
        }
