 ...
 * значений ГИС, отнимая определенное значение.
 */
public class FullIntervalGISMinusValue extends FullIntervalGIS {

    private String typeOfMinusValue = "отнять медиану"; //выставлен по умолчанию

    public FullIntervalGISMinusValue(String[] inputParameters) throws TaskException {
